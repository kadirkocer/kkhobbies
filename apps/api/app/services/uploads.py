...
def detect_mime_type(content: bytes, filename: str) -> str | None:
    """
...
def validate_file_security(content: bytes, filename: str, kind: str | None) -> str:
    """
...
async def store_upload(file: UploadFile, kind: str | None = None) -> dict[str, Any]:
    """
